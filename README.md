...
Проект представляет из себя интерактивную страницу блога с возможностью изменения стилей отображения контента через боковую панель.
В ходе работы была реализована логика функционирования компонентов: разделено хранение состояний между страницей и формой, передача данных между ними.
